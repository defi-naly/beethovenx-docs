...
Since the implementation of BIP-24, Beethoven X also offers Gauge Bounties for users to vote for Gauge pools that actively contribute to more than 2% of the previous month's protocol fees. Gauge Pools contributing to less than 2% of the month's previous Fantom protocol fees are capped at 1% of the vote allocation.
...
* The BPT contract needs to be verified (see [Pool Verification](https://docs-beta.beets.fi/technicals/pool-verification))
