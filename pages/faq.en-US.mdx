...
**There is no liquidity when I want to sell my BPTs or maBEETS (or I see a large price drop if I want to trade maBEETS)**

In normal circumstances, you don't want to trade/swap them, instead, go to the pool page to withdraw your liquidity. For maBEETS, go to [BeethovenX - maBEETS](https://beets.fi/mabeets), select a relic and withdraw from it.
...
or, if the incentive is paid on [Hidden Hand](https://hiddenhand.finance/beethovenx), you shall claim it there.
