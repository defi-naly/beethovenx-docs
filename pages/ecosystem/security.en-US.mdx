...
We have also completed a Beets specific audit with one of the most highly regarded Audit firms in DeFi - [Trail of Bits](https://www.trailofbits.com) . You can read the full audit [here](https://github.com/trailofbits/publications/blob/master/reviews/BeethovenXSummary.pdf).


## Bug Bounties

As a community, Beets has been an active contributor to the Balancer Labs Bug Bounty programme; one of the [largest bug bounties](https://immunefi.com/bounty/balancer/) in DeFi valued up to $1,000,000. 
