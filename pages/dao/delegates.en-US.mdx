# Delegates
Delegation is a mechanism through which maBEETS holders can entrust their voting power via Snapshot to one or more chosen delegates. This is done through snapshot’s UI.
...
Each prospective delegate will create a thread in this section of the forum. The first post should be your pitch to maBEETS holders about why you would be a good delegate. Following that you are expected to update your thread each time you cast a vote and include the reasons why you voted that way. This allows a track record to be built which maBEETS holders can assess.
