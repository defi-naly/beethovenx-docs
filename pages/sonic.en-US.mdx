...
1) Unstake their sFTMx using the "Unstake" tab on the [sFTMx UI](https://beets.fi/sftmx).*

2) Wait until the 24 hour unstaking period concludes and then withdraw the FTM using the "Withdraw" tab on the [sFTMx UI](https://beets.fi/sftmx).*
