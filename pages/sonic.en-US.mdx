...
Migrating FTM to S will be available through official Sonic Labs' bridge. (link TBA).
...
3) Exchange wFTM for S (Sonic's native token) through Sonic Labs' mechanism (link TBA).
...
2) Bridge BEETS to Sonic via the method outlined above.
