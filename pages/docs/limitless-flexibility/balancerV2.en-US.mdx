...
_Modular. Flexible. Future-proof. Balancer V2 is a one-stop shop for liquidity provision._ 
...
Balancer's initial innovation, the weighted pool, is based on an N-dimensional invariant surface which is a generalization of the constant product formula described by Vitalik Buterin and proven viable by the popular Uniswap dapp.
